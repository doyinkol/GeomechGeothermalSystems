# GeomechGeothermalSystems
This repository contains all the data needed to reproduce the results presented in our published papers: 
...
"Kolawole, O., Ispas, I., Kolawole, F., Germay, C., & McLennan, J. D. (2021). Scratch Test Characterization of Heterogeneous Rock Mechanical Properties with Applications to Enhanced Geothermal Systems. Mendeley Data, V5. https://doi.org/10.17632/xwhnkzzdmm.5". This is Medeley's data access to the data.
